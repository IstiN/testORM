...
public class AudiosDao extends AbstractDao<Audios, Long> {
    ...
    */
    ...
    private Query<Audios> content_AudiosQuery;
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"AUDIOS\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"AUDIOS\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Audios entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Audios entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Audios entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** Internal query to resolve the "audios" to-many relationship of Content. */
    public List<Audios> _queryContent_Audios(Long contentId) {
        synchronized (this) {
            if (content_AudiosQuery == null) {
                QueryBuilder<Audios> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.ContentId.eq(null));
                content_AudiosQuery = queryBuilder.build();
            }
        }
        Query<Audios> query = content_AudiosQuery.forCurrentThread();
    ...
    protected Audios loadCurrentDeep(Cursor cursor, boolean lock) {
        Audios entity = loadCurrent(cursor, 0, lock);
    ...
    public Audios loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Audios> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Audios> list = new ArrayList<Audios>(count);
    ...
    protected List<Audios> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Audios> queryDeep(String where, String... selectionArg) {
