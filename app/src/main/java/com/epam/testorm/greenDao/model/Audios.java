...
public class Audios {
    ...
    private transient AudiosDao myDao;
    ...
    public Audios(Long id, String url, String title, String image, String original, String thumbnail, String description, Long contentId) {
        this.id = id;
        this.url = url;
        this.title = title;
        this.image = image;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getAudiosDao() : null;
    }
